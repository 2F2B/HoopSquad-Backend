...
function LoginGoogle(code) { // 유저 코드 넘어옴
...
function ValidateGoogle(req) { // 유저 토큰 넘어옴
  return __awaiter(this, void 0, void 0, function* () {
      ...
      if (TokenResult) {
        ...
        if (yield (0, token_1.AccessVerify)(req.body.access_token)) {
          ...
          if (
            ...
            TokenResult.RToken_Expires +
              parseInt(TokenResult.RToken_CreatedAt) >
            604800
          ) {
            const user_data = {
